-- =====================================================
-- Migration 002: Add brand/sku/tags columns + Seed 40 products
-- =====================================================
...
-- Admin RLS policies for products (allow admin CRUD)
...
-- Also allow reading ALL products (not just active) for admin
